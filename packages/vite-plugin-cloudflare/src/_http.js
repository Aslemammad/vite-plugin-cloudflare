...
function httpsValidateParams(params) {
  ...
  if (params.protocol !== "https:") {
    throw new Error(
      'Protocol "' + params.protocol + '" not supported. Expected "https:"'
    );
  }
  return params;
}

import { toASCII } from "rollup-plugin-node-builtins/src/es6/punycode";
import {
  parse as qsParse,
  stringify as qsStringify,
} from "rollup-plugin-node-builtins/src/es6/qs";
